import { FollowerModel } from '../../../features/followers/models/follower.schema';
import { UserModel } from '../../../features/user/models/user.schema';
import { ObjectId, BulkWriteResult } from 'mongodb';
import mongoose, { Query } from 'mongoose';
import { IFollowerData, IFollowerDocument } from '../../../features/followers/interfaces/follower.interface';
...
class FollowerService {
  public async addFollowerToDB(userId: string, followeeId: string, username: string, followerDocumentId: ObjectId): Promise<void> {
    ...
    ///////// Notification Feature Starts by checking if user have notifications enable //////////////
